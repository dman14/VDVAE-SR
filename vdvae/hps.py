...
def add_vae_arguments(parser):
    ...
    parser.add_argument('--data_root', type=str, default='drive/MyDrive/UNI stuff/Master Thesis/Data/Test_Datasets/Urban100/')
    ...
    parser.add_argument('--dataset', type=str, default='ffhq_256')

    parser.add_argument('--ema_rate', type=float, default=0.999)

    parser.add_argument('--enc_blocks', type=str, default="256x3,256d2,128x8,128d2,64x12,64d2,32x17,32d2,16x7,16d2,8x5,8d2,4x5,4d4,1x4")
    parser.add_argument('--dec_blocks', type=str, default="1x2,4m1,4x3,8m4,8x4,16m8,16x9,32m16,32x21,64m32,64x13,128m64,128x7,256m128")
    ...
    parser.add_argument('--skip_threshold', type=float, default=180.)
    parser.add_argument('--lr', type=float, default=0.00015)
    parser.add_argument('--lr_prior', type=float, default=0.00015)
    parser.add_argument('--wd', type=float, default=0.01)
    parser.add_argument('--wd_prior', type=float, default=0.01)
    ...
    parser.add_argument('--epochs_per_eval_save', type=int, default=1)
    parser.add_argument('--num_images_visualize', type=int, default=2)
    parser.add_argument('--num_variables_visualize', type=int, default=3)
    parser.add_argument('--num_temperatures_visualize', type=int, default=1)
    return parser
